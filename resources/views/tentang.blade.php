...
<head>
  ...
  <title>Tentang TV9 Nusantara</title>
    ...
    tailwind.config = {
      theme: {
        extend: {
          colors: {
            'tv9-green': '#1a4d2e',
            'tv9-green-dark': '#0f2d1a',
            'tv9-green-mid': '#2d6a4f',
            'tv9-gold': '#c9a227',
            'tv9-gold-light': '#e8c547',
            'tv9-cream': '#f8f5ef',
          },
          fontFamily: {
...
<!-- Navigation -->
  ...
  <!-- ========= HERO ========= -->
  <section class="hero-bg min-h-[520px] relative flex items-center pt-12 pb-24 px-6">
    <div class="mosque-silhouette"></div>
    <div class="relative z-10 max-w-5xl mx-auto w-full">
      <div class="inline-block border border-tv9-gold/40 rounded-full px-4 py-1.5 mb-6">
        <span class="section-label">EST. 2010</span>
      </div>
      <h1 class="text-white text-5xl md:text-7xl font-black leading-tight mb-6 max-w-xl">
        Tentang <span class="text-tv9-gold">TV9</span><br/>Nusantara
      </h1>
      <p class="text-white/70 text-base md:text-lg max-w-md leading-relaxed font-light">
        Menjadi jangkar budaya dan spiritualitas Nusantara di era digital. Membawa kesejukan melalui syiar yang santun dan mencerahkan.
      </p>
      <div class="mt-8 flex gap-3">
        <div class="w-2 h-2 rounded-full bg-tv9-gold"></div>
        <div class="w-2 h-2 rounded-full bg-tv9-gold/50"></div>
        <div class="w-2 h-2 rounded-full bg-tv9-gold/25"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-20 px-6 bg-white">
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      <div class="reveal">
        ...
        <h2 class="text-4xl md:text-5xl font-bold text-tv9-green-dark mb-6 leading-tight">
          Santun<br/>Menyejukkan
        </h2>
        <div class="gold-divider w-20 mb-6"></div>
        <p class="text-gray-600 leading-relaxed mb-4">
          TV9 Nusantara hadir sebagai respons atas kebutuhan masyarakat akan tontonan yang tidak hanya menghibur, tetapi juga memotivasi. Sebagai pionir dalam penyiaran berbasis nilai budaya dan religi, kami berkomitmen untuk menyajikan konten yang mumi dan bermartabat.
        </p>
        <p class="text-gray-600 leading-relaxed">
          Kami percaya bahwa media memiliki tanggung jawab besar dalam membentuk karakter bangsa. Melalui proyek <em class="text-tv9-green font-medium">"The Digital Minaret"</em>, kami mengangkat kearifan lokal Nusantara ke panggung global dengan kemasan modern tanpa kehilangan akar identitasnya.
        </p>
      </div>

      <!-- Decorative Image Placeholder -->
      <div class="reveal reveal-delay-2 relative">
        <div class="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] bg-tv9-green-dark float-anim">
          <div class="absolute inset-0 flex items-center justify-center">
            <!-- Camera + Crescent decorative SVG -->
            <svg viewBox="0 0 320 240" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
              <rect width="320" height="240" fill="#1a4d2e"/>
              <rect width="320" height="240" fill="url(#grad1)"/>
              <defs>
                <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style="stop-color:#0f2d1a;stop-opacity:1"/>
                  <stop offset="100%" style="stop-color:#2d6a4f;stop-opacity:1"/>
                </linearGradient>
              </defs>
              <!-- Crescent moon -->
              <circle cx="220" cy="70" r="50" fill="#c9a227" opacity="0.85"/>
              <circle cx="240" cy="58" r="40" fill="#1a4d2e"/>
              <!-- Stars -->
              <circle cx="170" cy="40" r="3" fill="#e8c547" opacity="0.7"/>
              <circle cx="145" cy="70" r="2" fill="#e8c547" opacity="0.5"/>
              <circle cx="280" cy="110" r="2.5" fill="#e8c547" opacity="0.6"/>
              <!-- Camera body -->
              <rect x="90" y="130" width="140" height="80" rx="10" fill="#0f2d1a" stroke="#c9a227" stroke-width="2"/>
              <circle cx="160" cy="170" r="28" fill="#1a4d2e" stroke="#c9a227" stroke-width="2"/>
              <circle cx="160" cy="170" r="18" fill="#0f2d1a" stroke="#2d6a4f" stroke-width="1"/>
              <circle cx="160" cy="170" r="10" fill="#c9a227" opacity="0.3"/>
              <rect x="195" y="118" width="30" height="18" rx="4" fill="#0f2d1a" stroke="#c9a227" stroke-width="1.5"/>
              <rect x="90" y="138" width="20" height="12" rx="3" fill="#c9a227" opacity="0.6"/>
              <!-- Tripod legs -->
              <line x1="145" y1="210" x2="120" y2="240" stroke="#c9a227" stroke-width="2" opacity="0.5"/>
              <line x1="160" y1="210" x2="160" y2="240" stroke="#c9a227" stroke-width="2" opacity="0.5"/>
              <line x1="175" y1="210" x2="200" y2="240" stroke="#c9a227" stroke-width="2" opacity="0.5"/>
              <rect x="130" y="205" width="60" height="8" rx="4" fill="#c9a227" opacity="0.4"/>
            </svg>
          </div>
        </div>
        <!-- Decorative accent -->
        <div class="absolute -bottom-4 -left-4 w-24 h-24 rounded-full border-4 border-tv9-gold/20 -z-10"></div>
        <div class="absolute -top-4 -right-4 w-16 h-16 rounded-full bg-tv9-gold/10 -z-10"></div>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
      ...
      <div class="reveal card-hover bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
        <div class="value-icon w-12 h-12 rounded-xl flex items-center justify-center mb-5">
          <svg class="w-6 h-6 text-tv9-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
          </svg>
        </div>
        <h3 class="text-2xl font-bold text-tv9-green-dark mb-3">Visi Kami</h3>
        <div class="gold-divider w-12 mb-4"></div>
        <p class="text-gray-600 leading-relaxed">
          Menjadi referensi utama dunia dalam menyiarkan nilai-nilai Islam Nusantara yang moderat, toleran, dan berorientasi pada kemajuan peradaban global.
        </p>
      </div>
      ...
      <div class="reveal reveal-delay-2 card-hover bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
        ...
        <h3 class="text-2xl font-bold text-tv9-green-dark mb-3">Misi Kami</h3>
        <div class="gold-divider w-12 mb-4"></div>
        <ul class="space-y-3 text-gray-600">
          <li class="flex gap-3">
            <span class="text-tv9-gold font-bold mt-0.5">›</span>
  ...
  <section class="py-20 px-6 bg-white">
    <div class="max-w-3xl mx-auto">
      <div class="text-center mb-16 reveal">
        ...
        <h2 class="text-4xl md:text-5xl font-bold text-tv9-green-dark">Perjalanan Kami</h2>
        <div class="gold-divider w-24 mx-auto mt-4"></div>
      </div>

      <div class="relative">
        <!-- Center line -->
        <div class="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-tv9-gold via-tv9-gold/30 to-transparent -translate-x-1/2"></div>

        <!-- 2010 -->
        <div class="relative flex items-center mb-16 reveal">
          <div class="w-1/2 pr-10 text-right">
            <span class="text-tv9-gold text-4xl font-black font-display block">2010</span>
            <h4 class="text-lg font-bold text-tv9-green-dark mt-1 mb-2">Peletakan Batu Pertama</h4>
            <p class="text-gray-500 text-sm leading-relaxed">TV9 Nusantara didirikan di Surabaya sebagai televisi komunitas berbasis religi yang mengutamakan nilai Ahlussunnah wal Jamaah.</p>
          </div>
          <div class="absolute left-1/2 -translate-x-1/2 w-5 h-5 rounded-full bg-tv9-gold border-4 border-white shadow-md z-10"></div>
        ...
        <div class="relative flex items-center mb-16 reveal reveal-delay-2">
          ...
          <div class="w-1/2 pl-10">
            <span class="text-tv9-gold text-4xl font-black font-display block">2015</span>
            <h4 class="text-lg font-bold text-tv9-green-dark mt-1 mb-2">Ekspansi Satelit</h4>
            <p class="text-gray-500 text-sm leading-relaxed">Memperluas jangkauan ke seluruh wilayah Asia Tenggara melalui siaran satelit, menghadirkan layar premium menjangkau konten bermutu ke berbagai pelosok.</p>
          </div>
        </div>
        ...
        <div class="relative flex items-center reveal reveal-delay-4">
          <div class="w-1/2 pr-10 text-right">
            <span class="text-tv9-gold text-4xl font-black font-display block">2024</span>
            <h4 class="text-lg font-bold text-tv9-green-dark mt-1 mb-2">Transformasi Digital</h4>
            <p class="text-gray-500 text-sm leading-relaxed">Meluncurkan platform Digital Minaret, mengintegrasikan siaran TV dengan pengalaman digital interaktif dan on-demand.</p>
          </div>
          <div class="absolute left-1/2 -translate-x-1/2 w-5 h-5 rounded-full bg-tv9-gold border-4 border-white shadow-md z-10"></div>
          <div class="w-1/2 pl-10"></div>
        </div>
  ...
  <!-- ========= NILAI-NILAI INTI ========= -->
  <section class="py-20 px-6 bg-tv9-green-dark relative overflow-hidden">
    <!-- Decorative circles -->
    <div class="absolute top-0 right-0 w-96 h-96 rounded-full border border-white/5 translate-x-1/2 -translate-y-1/2"></div>
    <div class="absolute bottom-0 left-0 w-64 h-64 rounded-full border border-white/5 -translate-x-1/2 translate-y-1/2"></div>
    ...
    <div class="max-w-5xl mx-auto relative z-10">
      <div class="text-center mb-14 reveal">
        ...
        <p class="text-white/50 mt-3 max-w-md mx-auto text-sm">Prinsip yang membimbing setiap langkah kami dalam berkarya dan melayani pemirsa.</p>
        <div class="gold-divider w-24 mx-auto mt-4"></div>
      </div>

      <div class="grid md:grid-cols-3 gap-6">
        <!-- Integritas -->
        <div class="reveal card-hover bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
          <div class="w-14 h-14 mx-auto rounded-2xl bg-tv9-gold/10 flex items-center justify-center mb-4">
            <svg class="w-7 h-7 text-tv9-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
            </svg>
          </div>
          <h4 class="text-white font-bold text-lg mb-2">Integritas</h4>
          <p class="text-white/50 text-sm leading-relaxed">Kejujuran dan konsistensi dalam setiap informasi yang disampaikan kepada publik.</p>
        </div>

        <!-- Komunitas -->
        <div class="reveal reveal-delay-2 card-hover bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
          <div class="w-14 h-14 mx-auto rounded-2xl bg-tv9-gold/10 flex items-center justify-center mb-4">
            <svg class="w-7 h-7 text-tv9-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p class="text-white/50 text-sm leading-relaxed">Membangun harmoni dan mempersatukan perbedaan antar elemen bangsa.</p>
        </div>

        <!-- Keunggulan -->
        <div class="reveal reveal-delay-4 card-hover bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-7 text-center">
          <div class="w-14 h-14 mx-auto rounded-2xl bg-tv9-gold/10 flex items-center justify-center mb-4">
            <svg class="w-7 h-7 text-tv9-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p class="text-white/50 text-sm leading-relaxed">Kualitas penyiaran terbaik dengan standar estetika dan teknologi terkini.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-20 px-6 bg-white">
    <div class="max-w-5xl mx-auto">
      <div class="text-center mb-14 reveal">
        ...
        <h2 class="text-4xl md:text-5xl font-bold text-tv9-green-dark">Dewan Direksi &amp; Manajemen</h2>
        <div class="gold-divider w-24 mx-auto mt-4"></div>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div class="reveal group">
          <div class="relative rounded-2xl overflow-hidden mb-4 bg-gray-100 aspect-[3/4]">
            <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-tv9-green to-tv9-green-mid">
              <svg class="w-20 h-20 text-white/20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
              </svg>
            </div>
            <div class="team-overlay absolute inset-0 bg-tv9-gold/20 flex items-end p-4">
              <div class="w-full h-0.5 bg-tv9-gold"></div>
            </div>
          </div>
          <h4 class="font-bold text-tv9-green-dark text-sm">Dr. Ahmad Ridwan</h4>
          <p class="text-tv9-gold text-xs font-medium mt-0.5">Direktur Utama</p>
          <p class="text-gray-400 text-xs mt-1 leading-relaxed">Veteran media dengan pengalaman 20 tahun di bidang penyiaran nasional.</p>
        </div>

        <div class="reveal reveal-delay-1 group">
          <div class="relative rounded-2xl overflow-hidden mb-4 bg-gray-100 aspect-[3/4]">
            <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-tv9-green-mid to-tv9-green">
              <svg class="w-20 h-20 text-white/20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
              </svg>
            </div>
          ...
          <h4 class="font-bold text-tv9-green-dark text-sm">Sri Aminah, M.A.</h4>
          <p class="text-tv9-gold text-xs font-medium mt-0.5">Direktur Program &amp; Konten</p>
          <p class="text-gray-400 text-xs mt-1 leading-relaxed">Praktisi komunikasi yang lebih fokus pada pengembangan konten edukatif Nusantara.</p>
        </div>

        <div class="reveal reveal-delay-2 group">
          <div class="relative rounded-2xl overflow-hidden mb-4 bg-gray-100 aspect-[3/4]">
            <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-tv9-green to-tv9-green-dark">
              <svg class="w-20 h-20 text-white/20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
              </svg>
            </div>
          ...
          <h4 class="font-bold text-tv9-green-dark text-sm">Ir. Bambang Sutedja</h4>
          <p class="text-tv9-gold text-xs font-medium mt-0.5">Direktur Operasional</p>
          <p class="text-gray-400 text-xs mt-1 leading-relaxed">Insinyur berpengalaman yang mengawasi infrastruktur dan efektivitas penyiaran digital TV9.</p>
        </div>

        <div class="reveal reveal-delay-3 group">
          <div class="relative rounded-2xl overflow-hidden mb-4 bg-gray-100 aspect-[3/4]">
            <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-tv9-green-dark to-tv9-green-mid">
              <svg class="w-20 h-20 text-white/20" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
              </svg>
            </div>
          ...
          <h4 class="font-bold text-tv9-green-dark text-sm">Hafidz Abdullah</h4>
          <p class="text-tv9-gold text-xs font-medium mt-0.5">Kepala Strategi Digital</p>
          <p class="text-gray-400 text-xs mt-1 leading-relaxed">Inovator digital yang mentransformasi TV9 menjadi pemain media terkemuka di Indonesia.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-brand-green-light rounded-2xl px-10 py-12 font-sans">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <!-- Kolom Kiri -->
                <div>
                    <h2 class="text-4xl font-bold text-tv9-green-900-dark leading-tight mb-4">
                        Legalitas &<br />Izin Penyiaran
                    </h2>
                    <p class="text-base text-tv9-sage-900 leading-relaxed mb-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div
                            ...
                            <p class="text-[10.5px] font-bold text-tv9-gold-500 uppercase tracking-widest leading-tight">
...
<section class="py-20 px-4 sm:px-6 max-w-6xl mx-auto">
  ...
  <section class="py-20 px-6 pattern-bg">
    <div class="max-w-2xl mx-auto text-center reveal">
      ...
      <h2 class="text-4xl md:text-5xl font-bold text-tv9-green-dark mb-5">Mari Berkolaborasi</h2>
      <p class="text-gray-500 leading-relaxed mb-8">
        Bergabunglah bersama kami dalam upaya menyebarkan pesan positif dan membangun peradaban Nusantara yang lebih baik melalui media yang mencerahkan.
      </p>
  ...
  <!-- ========= FOOTER ========= -->
  <footer class="bg-tv9-green-dark text-white py-14 px-6">
    <div class="max-w-5xl mx-auto">
      <div class="grid md:grid-cols-4 gap-8 mb-10">
        <div class="md:col-span-1">
          ...
          <p class="text-white/40 text-xs leading-relaxed">Media Islam Nusantara yang Santun dan Mencerahkan.</p>
          <div class="flex gap-3 mt-4">
            <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-tv9-gold/30 transition-colors">
              <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557a9.83 9.83 0 01-2.828.775 4.932 4.932 0 002.165-2.724 9.864 9.864 0 01-3.127 1.195 4.916 4.916 0 00-8.384 4.482C7.691 8.094 4.066 6.13 1.64 3.161a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.061a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.937 4.937 0 004.604 3.417 9.868 9.868 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 002.46-2.548l-.047-.02z"/></svg>
            </a>
            <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-tv9-gold/30 transition-colors">
              <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.632-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12.017 24c6.624 0 11.99-5.367 11.99-11.987S18.641.001 12.017.001z"/></svg>
            </a>
            <a href="#" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-tv9-gold/30 transition-colors">
              <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-white/50 text-xs">
            ...
            <li><a href="#" class="hover:text-white transition-colors">Alumni &amp; Iklan</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-white/50 text-xs">
            ...
            <li><a href="#" class="hover:text-white transition-colors">TentangKami</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-white/50 text-xs">
            <li>Jl. Raya Darmo No. 9</li>
            <li>Surabaya, Jawa Timur</li>
            <li>info@tv9nusantara.com</li>
      ...
      <div class="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-white/30 text-xs">© 2024 TV9 Nusantara. Mulyosewaran &amp; Seterusnya.</p>
