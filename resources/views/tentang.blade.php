            ...
            <div class="w-full overflow-hidden">
                <div class="gallery-container">
                    ...
                    <div class="reveal gallery-item">
                        <button href="{{ asset('img/gallery/1.jpeg') }}" data-lightbox="portfolio">
                            <img src="{{ asset('img/gallery/1.jpeg') }}" alt="P1">
                        </button>
                    </div>
                    <div class="reveal reveal-delay-1 gallery-item ">
                        <button href="{{ asset('img/gallery/2.jpeg') }}" data-lightbox="portfolio">
                            <img src="{{ asset('img/gallery/2.jpeg') }}" alt="P2">
                        </button>
                    </div>
                    <div class="reveal gallery-item">
                        <button href="{{ asset('img/gallery/3.jpeg') }}" data-lightbox="portfolio">
                            <img src="{{ asset('img/gallery/3.jpeg') }}" alt="P3">
                        </button>
                    </div>
                    <div class="reveal gallery-item">
                        <button href="{{ asset('img/gallery/4.jpeg') }}" data-lightbox="portfolio">
                            <img src="{{ asset('img/gallery/4.jpeg') }}" alt="P4">
                        </button>
                    </div>
                </div>
            </div>
