                                ...
                                <div class="flex flex-col items-center gap-6">
                                    ...
                                    <div
                                        ...
                                        <p class="text-gray-500 text-sm leading-relaxed">
                                            TV9 Nusantara memegang pangsa pasar yang signifikan di
                                            antara stasiun TV lokal lainnya,
                                            khususnya di wilayah Gerbang Kertosusila (Grt Surabaya).
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="marquee-wrapper w-full overflow-hidden relative" id="marquee-wrapper">
                <div class="marquee-track flex items-center" id="marquee-track" style="gap: 24px;">
                    ...
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/beacukai.jpg') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/bhs.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                    </div>
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                    ...
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/logo-DPRD.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                    ...
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        ...
                        <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                            <img src="{{ asset('img/partner/logo.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                        <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        ...
                        <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/Logo_PLN.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                        <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                    ...
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/logo-icon.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                    ...
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/savoria-new.png') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                        </div>
                    <div class="flex-shrink-0 w-[80px] h-[80px] md:w-[100px] md:h-[100px] rounded-xl flex items-center justify-center p-3">
                        <img src="{{ asset('img/partner/sayang.jpg') }}" alt="Logo" class="w-full h-full object-contain" draggable="false">
                    </div>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8 mb-10">
                <div class="md:col-span-1">
                    ...
                    <p class="text-white/40 text-xs leading-relaxed">Santun
                        Menyejukkan
                    </p>
                ...
                <div>
                    <h5 class="font-semibold text-sm mb-4 text-tv9-gold-600-600-600-600-600">
                        Navigasi</h5>
                    <ul class="space-y-2 text-white/50 text-xs">
                        <li><a href="{{ route('tentang') }}" class="hover:text-white transition-colors">Tentang
                                Kami</a>
                        </li>
                        <li><a href="{{ route('layanan') }}" class="hover:text-white transition-colors">Layanan</a>
                        </li>
                        <li><a href="{{ route('kontak') }}" class="hover:text-white transition-colors">Hubungi
                                Kami</a>
                        </li>
                        <li><a href="{{ route('sitemap') }}" class="hover:text-white transition-colors">Sitemap</a>
                        </li>
                        <li><a href="" class="hover:text-white transition-colors">Pedoman
                                Pers</a></li>
                        </ul>
                        </div>
                <div>
                    ...
                    <ul class="space-y-2 text-white/50 text-xs">
                        <li><a href="{{ route('berita.index') }}" class="hover:text-white transition-colors">Jurnal
                                9</a></li>
                        <li><a href="{{ route('live') }}" class="hover:text-white transition-colors">Live
                                TV</a></li>
                        <li><a href="{{ route('jadwal') }}" class="hover:text-white transition-colors">Jadwal
                                Acara</a>
                        </li>
            ...
            <div class="border-t border-tv9-gold-600/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-white/30 text-xs">&copy; {{ date('Y') }} TV9
                    Nusantara. PT.
                    Dakwah Inti Media. All rights
                    reserved.
                </p>
