...
<body class="antialiased text-gray-800">
    ...
    <section class="bg-gray-50 flex items-center justify-center p-8">
        <div class="w-full max-w-5xl" data-aos="fade-up" data-aos-delay="100">
            <!-- Heading -->
            <div class="mb-8">
                <h2 class="title-underline text-2xl font-semibold text-gray-900 tracking-tight">AKSES
                    MULTIPLATFORM</h2>
            </div>
            <!-- Cards Grid -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="card bg-gray-100 rounded-2xl p-6 border border-gray-200">
                    ...
                    <p class="text-xs text-gray-400 mb-3 uppercase tracking-wide font-medium">Download Aplikasi
                        Kami</p>
                    <!-- Google Play -->
                    <a href="#"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                @forelse($schedules ?? [] as $program)
                    ...
                    : 'border-gray-200 hover:shadow-md' }}
                                ...
                                {{-- Jam --}}
                                <p class="text-xs font-semibold {{ $isLive ? 'text-[#006747]' : 'text-gray-400' }} mt-3">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-green-100/70 leading-relaxed mb-8 max-w-sm">
                        Reach a dedicated, high-engagement audience through our premium advertising and
                        custom
                        marketing
                    ...
                    <div class="space-y-5 mb-10">
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-100/60 leading-relaxed">Strategic TV
                                    commercials
                                    and
                                    program sponsorships during
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-100/60 leading-relaxed">Multi-channel digital
                                    campaigns
                                    across our web, mobile, and
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-100/60 leading-relaxed">In-house production for
                                    branded
                                    segments and documentary-style
                                    advertisements.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative">
                    <div class="image-card w-full aspect-[4/3] bg-gray-800 overflow-hidden">
                        ...
                        <img src="{{ asset('img/profile1.jpg') }}" alt="Library Media"
    ...
    <section class="w-full bg-white py-14 px-8">
        <div class="max-w-5xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Jurnal 9: Berita Terkini
                    </h2>
                    <div class="w-12 h-[3px] bg-yellow-600 rounded mt-2"></div>
                </div>
    ...
    <section class="w-full media-section py-16 px-8">
        <div class="max-w-5xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-white text-sm">Apa kata mereka tentang dampak positif TV9 Nusantara bagi
                    masyarakat.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed italic mb-6 card-text">
                            "TV9 Nusantara menjadi rujukan keluarga kami untuk konten religi yang
                            menyejukkan.
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-brand-green flex items-center justify-center text-white text-xs font-bold flex-shrink-0 card-avatar">
                            AK</div>
                        <div>
                            <p class="text-xs font-bold text-gray-900 uppercase tracking-wide card-name">
                                Ahmad
                                Kurniawan
                            </p>
                            <p class="text-xs text-gray-400 card-role">Tokoh Masyarakat, Jombang</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        <i class="fa-solid fa-quote-right text-4xl text-gray-100 card-quote float-right ml-3 -mt-1"></i>
                        <p class="text-gray-600 text-sm leading-relaxed italic font-medium mb-6 card-text">
                            "Sangat terbantu dengan aplikasi mobile TV9. Bisa menyimak kajian kitab
                            dimanapun.
                            Kualitas
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold flex-shrink-0 card-avatar">
                            SP</div>
                        <div>
                            <p class="text-xs font-bold text-gray-900 uppercase tracking-wide card-name">
                                Siti
                            ...
                            <p class="text-xs text-gray-400 card-role">Guru, Samarinda</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        <i class="fa-solid fa-quote-right text-4xl text-gray-100 card-quote float-right ml-3 -mt-1"></i>
                        <p class="text-gray-600 text-sm leading-relaxed italic mb-6 card-text">
                            "Sebagai pelaku UMKM, iklan di TV9 sangat efektif menjangkau pasar yang loyal.
                            Tim
                            produksinya
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-yellow-500 flex items-center justify-center text-white text-xs font-bold flex-shrink-0 card-avatar">
                            BR</div>
                        <div>
                            <p class="text-xs font-bold text-gray-900 uppercase tracking-wide card-name">
                                Budi
                            ...
                            <p class="text-xs text-gray-400 card-role">Wirausaha, Gresik</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
                        <a class="inline-block mb-4">
                            ...
                            <h1 class="text-xl lg:text-xl font-semibold text-black">PT. Dakwah Inti Media
                            </h1>
                        </a>
                        <p class="text-black leading-relaxed mb-4">
                            TV9 Nusantara merupakan stasiun televisi lokal di Kota Surabaya dan
                            menjadi salah satu awal televisi swasta di Indonesia yang memiliki karakter
                            pemirsa
                            komunitas
                            yang bernuansa Islam. TV9 dikelola oleh PT. Dakwah Inti Media, perusahaan yang
                            dimiliki oleh
                            KH. Moh. Hasani Mutawakkil `Alallah, S.H.,M.M., termasuk di dalamnya organisasi
                            sosial
                            keagamaan
                            Nahdlatul 'Ulama (PWNU) Jawa Timur ini diluncurkan pada tanggal 31 Januari 2010
                            oleh
                            Soekarwo
                            sebagai bagian dari perayaan ulang tahun Nahdlatul 'Ulama ke-84. Bersiaran di
                            kanal
                            42 UHF,
                            TV9
                            telah memperoleh Izin Penyelenggaraan Penyiaran prinsip tertanggal pada 7 Juli
                            2009
                            dan Izin
                    ...
                    <div class="w-full lg:w-1/2 px-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <h4 class="text-3xl lg:text-2xl font-semibold text-black mb-4 mt-4">Kontak</h4>
        ...
        (async function () {
            ...
            try {
                ...
                grid.innerHTML = posts.map(post => {
                    ...
                    const imgUrl = media?.media_details?.sizes?.medium?.source_url || media
                        ?.source_url ||
                        '';
