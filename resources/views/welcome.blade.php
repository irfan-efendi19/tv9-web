        ...
        <div id="jadwal" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($schedules ?? [] as $program)
                    ...
                    @endphp
                    <div
                        class="bg-white rounded-2xl p-6 shadow-sm border {{ $isLive ? 'border-red-500 shadow-md ring-1 ring-red-500/50' : 'border-gray-100 hover:shadow-xl hover:border-emerald-700/30' }} transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
