...
<head>
    ...
    <meta name="description"
        content="Dapatkan berita Islami terkini seputar Nahdlatul Ulama (NU), pesantren, dan dakwah Aswaja di Nusantara. Jurnal9 TV9 menyajikan informasi santun, menyejukkan, dan terpercaya untuk warisan intelektual Indonesia.">
    ...
    <div class="news-gradient py-12 md:py-20 overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-emerald-50 text-lg">Informasi terbaru seputar kiprah santri, kiai, dan dinamika Islam
                    Nusantara dari Jurnal9.</p>
            </div>
        </div>
    </div>
