                ...
                <div class="p-8">
                    <form action="{{ route('catalog.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-2">URL Gambar Poster (Opsional)</label>
                                <input type="url" name="image_url" class="w-full rounded-xl border-slate-200 focus:border-emerald-500 focus:ring-emerald-500" placeholder="https://example.com/poster.jpg">
                            </div>
                            <div>
