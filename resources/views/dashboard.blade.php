                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            <a href="{{ route('program.edit', $prog) }}"
                                                class="flex items-center gap-1 p-2 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all font-medium text-sm">
                                            ...
                                            <form action="{{ route('program.destroy', $prog) }}" method="POST"
                                                ...
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                                    class="flex items-center gap-1 p-2 text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all font-medium text-sm">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                                    Hapus
                                                </button>
                                            </form>
